...
type VariableRenaming() as this =
    inherit SyntaxTreeTransformation()

    do
        this.Namespaces <- VariableRenamingNamespaces(this)
        this.Statements <- VariableRenamingStatements(this)
        this.StatementKinds <- VariableRenamingStatementKinds(this)
